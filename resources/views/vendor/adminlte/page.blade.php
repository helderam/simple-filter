        ...
        <div class="{{config('adminlte.classes_topnav_container', 'container')}}">
            ...
            <nav
                ...
                <ul
                    ...
                    @endif
                    <!-- TESTE DE MENU SUSPENSO - NAO ABRE OPÇÔES !!!!
                        <li class="nav-item dropdown">
                            <a role="button" class="dropdown-toggle nav-link">
                                <span>
                                    <img src="vendor/adminlte/dist/img/AdminLTELogo.png"
                                        class="avatar-photo" alt="FOTO"/>

                                    <span class="hidden-md-down">Helder Morais</span>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a href="http://localhost:8000/admin/profile" class="dropdown-item"><i
                                        class="fa fa-user"></i> Profile</a>
                                <a href="http://localhost:8000/admin/password" class="dropdown-item"><i
                                        class="fa fa-key"></i> Password</a>

                                <a href="http://localhost:8000/admin/logout" class="dropdown-item"><i
